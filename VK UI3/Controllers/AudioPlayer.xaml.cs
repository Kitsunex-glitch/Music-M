...
namespace VK_UI3.Controllers
{
    ...
    /// </summary>
    {
        ...
        private async static Task PlayTrack(long? v = 0, TimeSpan? position = null)
        {
            ...
            sendStatDefaultGateTrack(trackdata);
        }




        private static async void sendStatDefaultGateTrack(ExtendedAudio trackdata)
        {
            ...
            StatDefaultGateLib.Models.Event @event = new StatDefaultGateLib.Models.Event("Play Track", DateTime.Now, eventParams: listParams);
