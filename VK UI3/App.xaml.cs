...
namespace VK_UI3
{
    ...
    public partial class App : Application
    {
        ...
        private async Task statDefaultGateRun()
        {
            try
            {
        ...
        /// <summary>
        /// Отправляет статистику об исключении в StatDefaultGate с полной информацией.
        /// </summary>
        private static void SendExceptionStat(Exception exception, object sender, string report)
        {
            try
            {
                ...
                var task = new MusicMStatDefaultGate().SendEvent(@event);
