        ...
        public string? getLinkFFMPEG()
        {
            switch (RuntimeInformation.OSArchitecture)
            {
                case Architecture.X86:
                    return "https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/Microsoft.WindowsAppRuntimeX64.1.4.msix";
                case Architecture.X64:
                    return "https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/Microsoft.WindowsAppRuntimeX86.1.4.msix";
                default:
                    return null;
            }
        }
