...
namespace VK_UI3.DownloadTrack
{
    public class CheckFFmpeg
    {
        ...
        public string getPathFfmpeg()
        {
            ...
            path = Path.Combine(path, "MusicMMKZ");
        ...
        public string? getLinkFFMPEG()
        {
            switch (RuntimeInformation.OSArchitecture)
            {
                case Architecture.X86:
                    return "https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/ffmpegX32.exe";
                case Architecture.X64:
                    return "https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/ffmpegX64.exe";
                case Architecture.Arm64:
                    return "https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/ffmpegARM64.exe";
                default:
                    return null;
            }
        }
