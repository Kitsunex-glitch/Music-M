...
namespace SetupLib
{
    public class AppUpdater
    {
        ...
        public Uri GetOSArchitectureURI()
        {
            if (RuntimeInformation.OSArchitecture == Architecture.Arm64)
            {
                return new Uri("https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/WindowsAppRuntimeInstall.1.6.3-arm64.exe");
            }
            else if (RuntimeInformation.OSArchitecture == Architecture.X64)
            {
                return new Uri("https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/WindowsAppRuntimeInstall.1.6.3-x64.exe");
            }
            else if (RuntimeInformation.OSArchitecture == Architecture.X86)
            {
                return new Uri("https://github.com/Kitsunex-glitch/Music-M/releases/download/0.1.0.0/WindowsAppRuntimeInstall.1.6.3-x86.exe");
            }
            else
            {
                throw new Exception("Неизвестная архитектура");
