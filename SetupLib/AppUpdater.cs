...
namespace SetupLib
{
    public class AppUpdater
    {
        ...
        {
            var releases = await client.Repository.Release.GetAll("Kitsunex-glitch", "VKUI3");
        ...
        public static Uri GetOSArchitectureURI()
        {
            if (RuntimeInformation.OSArchitecture == Architecture.Arm64)
            {
                return new Uri("https://github.com/Kitsunex-glitch/VKUI3/releases/download/0.1.0.0/Microsoft.WindowsAppRuntimeARM.1.4.msix");
            }
            
            else if (RuntimeInformation.OSArchitecture == Architecture.X64)
            {
                return new Uri("https://github.com/Kitsunex-glitch/VKUI3/releases/download/0.1.0.0/Microsoft.WindowsAppRuntimeX64.1.4.msix");
            }
            else if (RuntimeInformation.OSArchitecture == Architecture.X86)
            {
                return new Uri("https://github.com/Kitsunex-glitch/VKUI3/releases/download/0.1.0.0/Microsoft.WindowsAppRuntimeX86.1.4.msix");
            }
            else
            {
                throw new Exception("Неизвестная архитектура");
